            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="breadcrumb__wrap__content">
                        <h2 class="title">{{$recentblogs[0]->category()->first()->blog_category}}</h2>
                    ...
                    @foreach ($blogs as $blog)
                       <div class="standard__blog__post">
                        ...
                        <div class="standard__blog__content">
                            ...
                            <p>T{!!Str::limit($blog->blog_description,100)!!}</p>
                ...
                <div class="col-lg-4">
                    <aside class="blog__sidebar">
                        ...
                        <div class="widget">
                            ...
                            <ul class="rc__post">
                                @foreach ($recentblogs as $eachblog)
                                   <li class="rc__post__item">
                                    <div class="rc__post__thumb">
                                        <a href="{{route('blog.details',$eachblog->id)}}"><img src="{{asset($eachblog->blog_image)}}" alt=""></a>
                                    </div>
                                    <div class="rc__post__content">
                                        <h5 class="title"><a href="{{route('blog.details',$eachblog->id)}}">{{$eachblog->blog_title}}</a></h5>
