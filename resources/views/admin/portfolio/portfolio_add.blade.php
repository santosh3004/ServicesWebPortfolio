        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" name="portfolio_name" type="text"  id="title">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea id="portfolio_desccription" name="portfolio_description" class="form-control" maxlength="225" rows="3" placeholder="This textarea has a limit of 225 chars."></textarea>
...
<center>
                <input type="submit" class="btn btn-info btn-rounded waves-effect waves-light" value="Add Portfolio"/>
</center>
            </form>
            </div>
        </div>
